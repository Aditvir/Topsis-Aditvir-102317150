...
### Install via pip
```bash
pip install TOPSIS-Aditvir-102317150
```

### Install from source
```bash
git clone https://github.com/Aditvir/Topsis-Aditvir-102317150.git
cd Topsis-Aditvir-102317150
...
```python
from TOPSIS_ADITVIR_102317150 import TOPSIS
...
[Topsis-Aditvir-102317150](https://github.com/Aditvir/Topsis-Aditvir-102317150)
