...
sys.path.insert(0, r'c:\Users\DELL\Desktop\Predictive Analysis\topsis\TOPSIS-Aditvir-102317150')
...
if __name__ == "__main__":
    ...
    exec(open(r'c:\Users\DELL\Desktop\Predictive Analysis\topsis\TOPSIS-Aditvir-102317150\topsis1.py').read())
